package nttdatacenters.nttdatacentersSpringt5FMR;
...
public class NttdatacentersSpringT5FmrApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(NttdatacentersSpringT5FmrApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		final Logger MAINLOG = LoggerFactory.getLogger(NttdatacentersSpringT5FmrApplication.class);
